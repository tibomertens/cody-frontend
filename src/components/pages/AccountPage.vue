<template>
  <section>
    <div class="flex gap-[8px] mb-[20px] mt-[40px] md:ml-[40px] ml-[5%] items-center">
      ...
      <a href="#"><div><img src="/edit_no_fill.svg" alt="potlood"></div></a>
    </div>
    <div class="flex md:mx-[40px] ml-[5%] justify-center items-center bg-offWhite-light w-[90%] p-4 rounded">
      ...
      <div class="md:hidden flex gap-3">
        <div> 
          <img :src="`/${currentLabel}-label.svg`" :alt="`epc label ${label}`" class="w-[100%] mt-10">
          <p class="w-[100%] text-xs flex justify-center pt-4">
            Jouw label</p>
        </div>
          <div>
            <img :src="`/${goalLabel}-label.svg`" :alt="`epc label ${label}`" class="w-[100%] mt-10">
            <p class="w-[100%] text-xs flex justify-center pt-4">
              Jouw doel</p>
          </div>
      </div>
      ...
      <div class="flex justify-center">
        <div class="flex w-[90%] justify-between mt-[20px] px-4 mb-14 gap-4">
          <div class="md:flex md:gap-[32px]">
            <div><img src="/money.svg" alt="huidig budget" class="md:w-[58px] w-[40px]"></div>
            <div>
          ...
          <div class="md:flex md:gap-[32px]">
            <div><img src="/moneyLight.svg" alt="uitgegeven budget" class="md:w-[58px] w-[40px]"></div>
            <div>
