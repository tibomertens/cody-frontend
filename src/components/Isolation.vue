...
<template>
  <section class="mt-[64px]">
    ...
    <div class="mt-[32px] flex gap-[24px]">
      <Dropdown :width="'full'" :label="'Bewoonbare oppervlakte:'" :items="PithedRoofOptions" @itemSelected="handlePitchedRoof" />
      <Dropdown :width="'full'" :label="'Bewoonbare oppervlakte:'" :items="FlatRoofOptions" @itemSelected="handleFlatRoof" />
    </div>
  </section>
</template>
