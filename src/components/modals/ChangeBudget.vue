<template>
  <div v-if="showBudgetModal === true"
    ...
    <div class="bg-offWhite-dark p-8 rounded-lg shadow-md w-[85%] xs:w-[450px]">
      ...
      <Input label="Hoeveel budget wilt u toevoegen?" @input-change="budgetHandler" :placeholder="'bv. 2000'"
        :pre-fix="'€'" class="pb-[32px]" :error="hasError" />
